...
func findVTuberByHandleOrID(ctx context.Context, s *hololist.Store, idOrHandle string) (hololist.VTuber, error) {
	var (
		vtuber hololist.VTuber
		err    error
	)
...
func detectVTubers(ctx context.Context, s *hololist.Store, log logs.Log) ([]hololist.VTuber, error) {
	found := make([]hololist.VTuber, 0)
